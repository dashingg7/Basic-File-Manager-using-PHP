...
$PASSWORD = 'asdf';  // Set the password, to access the file manager... (optional)
...
<style>
body {font-family: Arial, Helvetica, sans-serif; font-size: 14px;width:1024;padding:1em;margin:0;}
th { border: 1px solid black; font-size: large; font-weight: normal; color: #3b6294; background-color: ; padding:.5em 1em .5em .2em;
	text-align: left;cursor:pointer;user-select: none;}
th .indicator {margin-left: 6px }
thead { border-top: 1px solid #82CFFA; border-bottom: 1px solid #96C4EA;border-left: 1px solid #E7F2FB;
	border-right: 1px solid #E7F2FB; }
#title {font: bold; font-size: large;}
#border {border: 5px outset black;
...
thead {border: 1px solid black; max-width: 1024px}
td {border: 1px solid black; padding:.2em 1em .2em .2em; border-bottom:1px solid black;height:30px; font-size:12px;white-space: nowrap;}
...
.is_dir .download{visibility: hidden; float: center}
a.delete {display:inline-block; float: left;
...
<div id="border">
	<?php if($allow_create_folder): ?>
		<form action="?" method="post" id="mkdir" />
			<label for=dirname></label><input id=dirname type=text name=name placeholder="Create New Folder" value="" />
	...
	<table id="table">
		...
		<th border: 1px solid black;>Size</th>
		<th border: 1px solid black;>Modified</th>
		<th border: 1px solid black;>Permissions</th>
		<th border: 1px solid black;>Actions</th> </tr>
		</thead>
		<tbody id="list"></tbody>
	</table>
	&nbsp;
